...
public class CommunityResponseDto {
    ...
    @Builder
    public CommunityResponseDto(String communityId, String communityTitle, Integer communityParticipant, String communityAuthor, String communityStatus, String communityMainImgPath) {
